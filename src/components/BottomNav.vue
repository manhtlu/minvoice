...
<template>
  <nav class="fixed bottom-0 left-0 right-0 z-20 pb-[env(safe-area-inset-bottom)]">
    <div class="bg-surface-lowest rounded-t-md shadow-lg mx-auto max-w-lg flex items-center justify-around h-20">
